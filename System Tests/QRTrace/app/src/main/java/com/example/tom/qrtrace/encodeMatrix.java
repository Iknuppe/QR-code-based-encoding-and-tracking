...
public class encodeMatrix
{
  static String encodeMatrix(int[][] qr_array)
  {
    ...
    //<Character> character_list = new ArrayList<>();
    String character_string = new String();
    character_string = "fail";
    ...
    switch(mode)
    {
      case 0x1: //Numeric Mode
      {
        ...
        //System.out.println("Convert to Numbers ...");
        try
        {
      ...
      case 0x4: //Byte Mode
      {
        System.out.println("Byte mode not implemented yet...");
      ...
      case 0x8: //Kanji Mode
      {
        System.out.println("Kanji mode not implemented yet...");
        return "Kanji";
        //break;
      }
      case 0x7: //ECI Mode
      {
        System.out.println("ECI mode not implemented yet...");
        return "ECI";
        //break;
      }
      default: break;
  ...
  static int[] encodeFormatVersionInformation(int[][] qr_array)
  {
    ...
    for(int counter = 0 ; counter <= dimension - 1 ; counter++)
    {
      ...
      {
        //System.out.print(qr_array[8][counter]);
...
/*
    ...
    {
      if(((counter > (dimension - 8)) || (counter < 9)) && (counter != 6) && (counter != (dimension - 8)))
      {
        System.out.print(qr_array[counter][8]);
        if(fvi[pos_counter] != qr_array[counter][8])
        {
          System.out.println("Format information missmatch.");
          return null;
        }
        pos_counter++;
      }
...
/*
    ...
    {
      if(fvi[counter] != qr_array[counter][8])
      {
        System.out.println("Format information missmatch.");
        return null;
      }
...
/*
  ...
  static String encodeInNumericMode(List<Integer> qr_data_list, int character_count)
  {
    int index = 0;
    ...
    while(index != character_count)
    {
      ...
      if(((index%10)==0)&&(index!=0))
      {
        if(Integer.parseInt(helpstring,2)<99)
        {
          ...
          {
            numbers = numbers + "0" + "0" + Integer.parseInt(helpstring,2);
          }
          else
          {
            numbers = numbers + "0" + Integer.parseInt(helpstring,2);
          }
        }
        else
        {
          numbers = numbers + Integer.parseInt(helpstring,2);
        }
        helpstring = "";
      }
    }
